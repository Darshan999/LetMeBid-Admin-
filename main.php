...
/*      $(function() {
        ...
        var lineChartData = {
        labels : <?php echo json_encode($results['week_number']); ?>,
        datasets : [
            {
                ...
                data : <?php echo json_encode($results['total_records']); ?> //[28,48,40,19,96,27,100]
            }
        ]
    ...
    var lineChartData = {
        labels : <?php echo json_encode($results['week_number']); ?>, //["X","Y","Z","A","B","C","D"],
        datasets : [
            {
                fillColor : "rgba(151,187,205,0.5)",
                strokeColor : "rgba(151,187,205,1)",
