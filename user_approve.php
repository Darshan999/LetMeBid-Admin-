         ...
         include'database.php';        
          ...
          while($row=mysql_fetch_assoc($res))
          {
            $user_email_id=$row["user_email_id"];
              ...
              <td><a href="userapp.php?user_email_id='.$user_email_id.'" class="btn btn-success"><span class="glyphicon glyphicon-ok" arial-hidden="true"></span></a>

              <a href="useraction.php?user_email_id='.$user_email_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></a></td>
              </tr>';
