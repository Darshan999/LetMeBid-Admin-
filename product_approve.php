...
<html lang="en">
 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Product Details</h1></center>
...
<table class="table table-striped table-advance table-hover" id="dataTable">
    ...
    <tbody>
      <?php
          ...
          $obj=new database();
          $res=$obj->productdisplay();
          

          while($row=mysql_fetch_assoc($res))
          {
            $product_id=$row["product_id"];
          $sortcontent=substr($row["product_description"],0,40)."...";
              ...
              <td><input type="checkbox" name="chk[]" value="<?php echo $row["product_id"]; ?>" /></td>
              <?php 
              echo '
              <td>'.$row["product_name"].'</td>
              
              <td><a href="prodesc.php?product_id='.$product_id.'">'.$sortcontent.'</a></td>
              <td><img src="image/'.$row["product_photo"].'" class="imgdisplay"/></td>
              <td>'.$row["product_min_bid_price"].'</td>
              
              <td><a href="productapp.php?product_id='.$product_id.'" class="btn btn-success"><span class="glyphicon glyphicon-ok" arial-hidden="true"></span></a>

              <a href="productaction.php?product_id='.$product_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></a></td>
              </tr>';
